...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 648.0, 606.0, 177.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 250.0, 432.5, 88.5833740234375, 20.0 ],
					"text" : "Max amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 250.0, 493.0, 124.5833740234375, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 250.0, 462.5, 88.5833740234375, 20.0 ],
					"text" : "Max amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.2083740234375, 661.0, 23.0, 20.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 474.975006103515625, 218.0, 72.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 568.0, 606.0, 74.3333740234375, 20.0 ],
					"text" : "Read me ->"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.0, 11.0, 285.0, 167.0 ],
									"text" : "*PATCH WILL TAKE 15 SECONDS TO INITIALISE*\n\n1. Change window size in the white box (DO NOT SCALE WINDOW DIRECTLY THROUGH CLICK AND DRAG).\n2. In the red box you can draw in the black square to warp spectrogram.\n3. Randomise or reset the box.\n4. Map an exponential or logarithmic curve over the box and change its exponent.\n7. Apply various EQ to audio.\n8. Choose playback option in the green box."
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 196.083343505859375, 67.0, 74.0, 22.0 ],
					"text" : "delay 15000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 113.5, 67.0, 74.0, 22.0 ],
					"text" : "delay 12000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 610.5999755859375, 319.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.5999755859375, 348.5, 78.0, 22.0 ],
					"text" : "v numframes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.0, 324.0, 60.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 302.5, 61.0, 20.0 ],
					"text" : "Exponent"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 239.0, 155.70001220703125, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 178.5, 40.0, 20.0 ],
					"text" : "Reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.399993896484375, 317.5, 67.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 126.0, 70.0, 20.0 ],
					"text" : "Randomise"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 752.0, 294.5, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.0, 294.5, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 214.59173583984375, 178.5, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 214.59173583984375, 126.0, 49.0, 22.0 ],
					"text" : "random"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 214.59173583984375, 239.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 752.0, 348.5, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 214.59173583984375, 302.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 496.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 35.0, 520.0, 100.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 462.5, 58.0, 20.0 ],
					"text" : "Denoiser"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 432.5, 45.0, 20.0 ],
					"text" : "Limiter"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 525.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 493.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 462.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 432.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 399.5, 109.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 598.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 45.0, 649.0, 261.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 399.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 45.0, 33.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.world frequency_warp_render @windowposition 929 90"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 377.0, 381.0, 197.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 13.0, 15.0, 554.0, 62.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 761.5, 331.0, 645.0, 331.0, 645.0, 306.0, 620.0999755859375, 306.0 ],
					"order" : 1,
					"source" : [ "obj-82", 0 ]
				}
